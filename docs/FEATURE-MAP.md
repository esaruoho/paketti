...
## 4,536 distinct features across 97 groups

| Feature group | features | ⌨ keyboard | 🎛 MIDI | ☰ menu |
|---|--:|--:|--:|--:|
| **(top level)** | 3011 | 2244 | 2532 | 569 |
| **(misc)** | 316 | 188 | 182 | 196 |
| **Instruments** | 103 | 70 | 71 | 103 |
...
### (top level)  ·  3011 features  ·  ⌨2244 🎛2532 ☰569
...
- **Amigo to Digitakt Chain** — _keyboard · MIDI_
- **Amigo to Impulse Tracker ITI** — _keyboard · MIDI_
- **Amigo to Polyend PTI** — _keyboard · MIDI_
...
- **Batch Every Amigo in Song to Digitakt Chain** — _keyboard · MIDI_
- **Batch Every Amigo in Song to Impulse Tracker ITI** — _keyboard · MIDI_
- **Batch Every Amigo in Song to Octatrack ot and wav** — _keyboard · MIDI_
- **Batch Every Amigo in Song to Polyend PTI** — _keyboard · MIDI_
- **Batch Every Amigo in Song to Renoise Drumkits** — _keyboard · MIDI_
- **Batch Every Amigo in Song to Renoise Instruments** — _keyboard · MIDI_
- **Batch Every Amigo in Song to WAV with CUE Header** — _keyboard · MIDI_
- **Batch Every Sampled Instrument in Song to Amigo** — _keyboard · MIDI_
...
- **Configure Parameter Editor for Selected Device** — _keyboard · MIDI · menu_
...
- **Export Digitakt Sample Chain...** — _keyboard · MIDI_
...
- **HyperEdit Ramp Ganged 00 to 127** — _keyboard · MIDI_
...
- **Load Phrase Presets from Folder Tree (Per Subfolder)...** — _keyboard · MIDI_
...
- **Open Selected Device with Parameter Editor** — _keyboard · MIDI · menu_
- **Open Selected Device with Parameter Editor [Trigger]** — _MIDI_
...
- **Paketti Drumkit Loader MuteTrig (Randomize)** — _keyboard · MIDI · menu_
...
- **Paketti Groovebox 8120 Hapax Probe Close** — _keyboard_
- **Paketti Groovebox 8120 Hapax Probe Open** — _keyboard_
- **Paketti Groovebox 8120 Hapax Probe Window** — _keyboard_
- **Paketti Groovebox 8120 Hapax Test LEDs** — _keyboard_
...
- **Send Sample Range to App Slot 1** — _MIDI_
- **Send Selected Sample to App Slot 1** — _MIDI_
...
- **Step Mute APCKey25 Step 01 [Trigger]** — _MIDI_
- **Step Mute Launchpad Step 01 [Trigger]** — _MIDI_
- **Step Mute LPD8 Step 01 [Trigger]** — _MIDI_
- **Step Mute MidiMix Step 01 [Trigger]** — _MIDI_
- **Step Mute Set Window Size 8 [Trigger]** — _MIDI_
- **Step Mute Set Window Size x[Knob]** — _MIDI_
- **Step Mute Show/Hide Dialog** — _keyboard · MIDI_
- **Step Mute Show/Hide Dialog [Trigger]** — _MIDI_
- **Step Mute Toggle Current Row** — _keyboard · MIDI_
- **Step Mute Toggle Current Row [Trigger]** — _MIDI_
- **Step Mute Toggle Step 01 [Trigger]** — _MIDI_
- **Step Mute Unmute All in Track** — _keyboard · MIDI_
- **Step Mute Unmute All in Track [Trigger]** — _MIDI_
- **Step Mute Window Next** — _keyboard · MIDI_
- **Step Mute Window Next [Trigger]** — _MIDI_
- **Step Mute Window Previous** — _keyboard · MIDI_
- **Step Mute Window Previous [Trigger]** — _MIDI_
- **Step Mute Window Size 8** — _keyboard · MIDI_
...
- **Toggle 0G01 at Current Row** — _keyboard · MIDI · menu_
- **Toggle 0G01 at Current Row [Trigger]** — _MIDI_
...
- **Toggle Sliced Imports Also Go Into Amigo** — _keyboard_
...
- **Batch Convert XRNI Folder to IFF...** — _keyboard · MIDI · menu_
- **Batch Convert XRNI Folder to ITI...** — _keyboard · MIDI · menu_
- **Batch Convert XRNI Folder to Octatrack (WAV+.ot)...** — _keyboard · MIDI · menu_
- **Batch Convert XRNI Folder to WAV (with CUE)...** — _keyboard · MIDI · menu_
...
- **Configure Launch App Selection...** — _keyboard · menu_
...
- **Digitakt Export Sample Chain...** — _MIDI · menu_
...
- **Export Amigo to Digitakt Chain (.wav)** — _MIDI · menu_
- **Export Amigo to Impulse Tracker ITI (.iti)** — _MIDI · menu_
- **Export Amigo to Octatrack (.ot + .wav)** — _MIDI · menu_
- **Export Amigo to Polyend PTI (.pti)** — _MIDI · menu_
- **Export Amigo to WAV with CUE Header** — _MIDI · menu_
- **Export Every Amigo in Song to Digitakt Chain (.wav)** — _MIDI · menu_
- **Export Every Amigo in Song to Impulse Tracker ITI (.iti)** — _MIDI · menu_
- **Export Every Amigo in Song to Octatrack (.ot + .wav)** — _MIDI · menu_
- **Export Every Amigo in Song to Polyend PTI (.pti)** — _MIDI · menu_
- **Export Every Amigo in Song to WAV with CUE Header** — _MIDI · menu_
- **Export Every Sampled Instrument in Song to Amigo** — _MIDI · menu_
- **Export Instrument to ITI...** — _keyboard · MIDI · menu_
- **Export Selected Sample to Amigo Sampler** — _MIDI · menu_
- **Export Selected Sample to Amigo Sampler (Embedded)** — _MIDI · menu_
...
- **Import Amigo as Renoise Drumkit (One-Shot per Slice)** — _MIDI · menu_
- **Import Every Amigo in Song to Renoise Instruments** — _MIDI · menu_
- **Import Sample from Amigo Sampler** — _menu_
...
- **Polyend (PTI) Batch Convert XRNI Folder to PTI...** — _MIDI · menu_
...
- **Polyend (PTI) Save Current as Drumkit (Mono)...** — _MIDI · menu_
- **Polyend (PTI) Save Current as Drumkit (Stereo)...** — _MIDI · menu_
- **Polyend (PTI) Save Current Sample as...** — _MIDI · menu_
...
- **Sliced Imports Also Go Into Amigo (RX2, REX, PTI, ITI, OT, WAV+CUE) Toggle** — _MIDI · menu_
...
### Instruments  ·  103 features  ·  ⌨70 🎛71 ☰103

- ** Every Amigo in Song to Renoise Drumkits** — _MIDI · menu_
...
- **BPM Slice & Amigo (1 Beat)** — _keyboard · MIDI · menu_
- **BPM Slice & Amigo (2 Beats)** — _keyboard · MIDI · menu_
- **BPM Slice & Amigo (Half Beat)** — _keyboard · MIDI · menu_
- **BPM Slice & Amigo (Quarter Beat)** — _keyboard · MIDI · menu_
- **Bypass All Sample FX on All Instruments** — _keyboard · menu_
- **Bypass All Sample FX on Selected Instrument** — _keyboard · menu_
- **Center** — _menu_
- **Chain Instrument Samples into Amigo** — _keyboard · MIDI · menu_
...
- **Dump Amigo State to Console** — _menu_
...
- **Load Phrase Presets from Folder Tree (One Instrument per Subfolder)...** — _MIDI · menu_
...
- **Pitchbend Loader to Amigo (Normalize)...** — _keyboard · MIDI · menu_
- **Print Amigo Slices to Pattern** — _keyboard · MIDI · menu_
- **Randomize** — _menu_
- **Renoise to Amigo (Selected Sample, Embedded)** — _keyboard · MIDI · menu_
...
- **Save Phrases of All Instruments as Presets (Subfolders)...** — _keyboard · MIDI · menu_
- **Scale 150%** — _menu_
...
- **Transient Slice & Amigo** — _keyboard · MIDI · menu_
- **Wipe Song Retain Sample** — _keyboard · menu_
- **Wipe&Slice&Amigo&Print (002)** — _keyboard · MIDI · menu_
...
### !Preferences  ·  64 features  ·  ⌨0 🎛29 ☰64
...
- **Hapax Probe — Close** — _menu_
- **Hapax Probe — Open Window (read pads, copyable)** — _menu_
- **Hapax Probe — Test grid LEDs (empirical)** — _menu_
...
### Xperimental/WIP  ·  36 features  ·  ⌨0 🎛21 ☰36
...
- **Dialog of Dialogs Screenshot All** — _menu_
...
- **Create Phrase Per Slice** — _keyboard · MIDI · menu_
- **Create Phrase Per Slice and Keymap** — _keyboard · MIDI · menu_
...
- **Map Phrases One Per Key** — _keyboard · MIDI · menu_
...
- **Spread Phrases Across Keyboard** — _keyboard · MIDI · menu_
...
- **Drumkit Loader to Amigo...** — _keyboard · MIDI · menu_
...
- **Pitchbend Loader to Amigo...** — _keyboard · MIDI · menu_
...
### Amigo  ·  16 features  ·  ⌨6 🎛16 ☰16

- ** Every Amigo in Song to Digitakt Chain (.wav)** — _MIDI · menu_
- ** Every Amigo in Song to Impulse Tracker ITI (.iti)** — _MIDI · menu_
- ** Every Amigo in Song to Octatrack (.ot + .wav)** — _MIDI · menu_
- ** Every Amigo in Song to Polyend PTI (.pti)** — _MIDI · menu_
- ** Every Amigo in Song to Renoise Instruments** — _MIDI · menu_
- ** Every Amigo in Song to WAV with CUE Header** — _MIDI · menu_
- ** Every Sampled Instrument in Song to Amigo** — _MIDI · menu_
- **Amigo to Digitakt Chain (.wav)** — _MIDI · menu_
- **Amigo to Impulse Tracker ITI (.iti)** — _MIDI · menu_
- **Amigo to Octatrack (.ot + .wav)** — _keyboard · MIDI · menu_
- **Amigo to Polyend PTI (.pti)** — _MIDI · menu_
- **Amigo to Renoise (New Instrument)** — _keyboard · MIDI · menu_
- **Amigo to Renoise Drumkit (One-Shot per Slice)** — _keyboard · MIDI · menu_
- **Amigo to WAV with CUE Header** — _keyboard · MIDI · menu_
- **Renoise to Amigo (Selected Sample)** — _keyboard · MIDI · menu_
- **Wipe&Slice&Amigo (002)** — _keyboard · MIDI · menu_
...
### Step Mute  ·  3 features  ·  ⌨0 🎛3 ☰3

- **Show Step Mute Dialog...** — _MIDI · menu_
- **Toggle Mute Current Row** — _MIDI · menu_
- **Unmute All in Track** — _MIDI · menu_
...
### Slice Fades  ·  3 features  ·  ⌨3 🎛3 ☰3

- **Fade Both Slice Ends 0.5ms** — _keyboard · MIDI · menu_
- **Fade Out Slice Ends 0.5ms** — _keyboard · MIDI · menu_
- **Slice Fades Dialog...** — _keyboard · MIDI · menu_
...
### Sequencer  ·  1 features  ·  ⌨0 🎛0 ☰1

- **Step Mute (Non-Destructive)...** — _menu_
