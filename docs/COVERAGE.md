...
## 11,797 distinct actions

| reachable by | count | meaning |
|---|--:|---|
| **KME** | 383 | all three |
| **KE** | 910 | keyboard + menu (no MIDI) |
| **KM** | 3,636 | keyboard + MIDI (no menu) |
| **ME** | 145 | MIDI + menu (no keyboard) |
| **K** | 2,672 | keyboard ONLY |
| **E** | 1,678 | menu ONLY (mouse-only) |
| **M** | 2,373 | MIDI ONLY |

- Keyboard 7,601 · MIDI 6,537 · Menu 3,116
- **Shortcut but NO MIDI:** 3,582 (controller users can't reach)
- **Shortcut but NO menu:** 6,308 (undiscoverable by browsing)
