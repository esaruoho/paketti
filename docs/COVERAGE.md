...
## 11,673 distinct actions

| reachable by | count | meaning |
|---|--:|---|
| **KME** | 375 | all three |
| **KE** | 918 | keyboard + menu (no MIDI) |
| **KM** | 3,625 | keyboard + MIDI (no menu) |
| **ME** | 124 | MIDI + menu (no keyboard) |
| **K** | 2,672 | keyboard ONLY |
| **E** | 1,694 | menu ONLY (mouse-only) |
| **M** | 2,265 | MIDI ONLY |

- Keyboard 7,590 · MIDI 6,389 · Menu 3,111
- **Shortcut but NO MIDI:** 3,590 (controller users can't reach)
...
|---|--:|--:|--:|--:|
| Global | 6,402 | 3,556 | 0 | **2,846** |
| Pattern Editor | 1,224 | 628 | 228 | **467** |
