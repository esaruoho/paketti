...
## 11,794 distinct actions

| reachable by | count | meaning |
|---|--:|---|
| **KME** | 383 | all three |
| **KE** | 910 | keyboard + menu (no MIDI) |
| **KM** | 3,635 | keyboard + MIDI (no menu) |
| **ME** | 145 | MIDI + menu (no keyboard) |
| **K** | 2,672 | keyboard ONLY |
| **E** | 1,676 | menu ONLY (mouse-only) |
| **M** | 2,373 | MIDI ONLY |

- Keyboard 7,600 · MIDI 6,536 · Menu 3,114
- **Shortcut but NO MIDI:** 3,582 (controller users can't reach)
- **Shortcut but NO menu:** 6,307 (undiscoverable by browsing)
- **Menu but NO shortcut:** 1,821 (mouse-only)
