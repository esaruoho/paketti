...
- **24,698 unique registration points**
  - **10,854 keyboard shortcuts**
  - **6,696 menu entries**
  - **7,148 MIDI mappings**

**Validation:** Paketti's own runtime counters say 10,849 keybindings / 7,159 MIDI / 6,693 menus — matching.

## What Paketti does for Renoise

Paketti is a **24,698-action layer** bolted onto Renoise. *Where* those actions live tells you its character:

- **Keyboard- and MIDI-first.** 7,043 shortcuts fire *anywhere* (the Global region) and 7,148 actions are MIDI-mappable — most of Paketti is reachable without ever opening a menu. It's built for speed and for hardware.
