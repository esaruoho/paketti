...
- **24,735 unique registration points**
...
Paketti is a **24,735-action layer** bolted onto Renoise. *Where* those actions live tells you its character:

- **Keyboard- and MIDI-first.** 7,043 shortcuts fire *anywhere* (the Global region) and 7,185 actions are MIDI-mappable — most of Paketti is reachable without ever opening a menu. It's built for speed and for hardware.
