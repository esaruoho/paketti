...
- **24,545 unique registration points**
  - **10,854 keyboard shortcuts**
  - **6,696 menu entries**
  - **6,995 MIDI mappings**

**Validation:** Paketti's own runtime counters say 10,849 keybindings / 6,994 MIDI / 6,693 menus — matching.

## What Paketti does for Renoise

Paketti is a **24,545-action layer** bolted onto Renoise. *Where* those actions live tells you its character:

- **Keyboard- and MIDI-first.** 7,043 shortcuts fire *anywhere* (the Global region) and 6,995 actions are MIDI-mappable — most of Paketti is reachable without ever opening a menu. It's built for speed and for hardware.
