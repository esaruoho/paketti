...
- **24,917 unique registration points**
  - **10,874 keyboard shortcuts**
  - **6,717 menu entries**
  - **7,326 MIDI mappings**

**Validation:** Paketti's own runtime counters say 10,869 keybindings / 7,325 MIDI / 6,714 menus — matching.

## What Paketti does for Renoise

Paketti is a **24,917-action layer** bolted onto Renoise. *Where* those actions live tells you its character:

- **Keyboard- and MIDI-first.** 7,051 shortcuts fire *anywhere* (the Global region) and 7,326 actions are MIDI-mappable — most of Paketti is reachable without ever opening a menu. It's built for speed and for hardware.
...
| **Menus & global** | | | | |
| &nbsp;&nbsp;Global | 7,051 | 482 | 515 | 8,048 |
| &nbsp;&nbsp;Paketti | 0 | 0 | 6,721 | 6,721 |
