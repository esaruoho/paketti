...
- **24,809 unique registration points**
  - **10,866 keyboard shortcuts**
  - **6,698 menu entries**
  - **7,245 MIDI mappings**

**Validation:** Paketti's own runtime counters say 10,861 keybindings / 7,244 MIDI / 6,695 menus — matching.

## What Paketti does for Renoise

Paketti is a **24,809-action layer** bolted onto Renoise. *Where* those actions live tells you its character:
...
- **Menus are the catalogue.** 6,698 menu entries make every feature browsable when you don't remember the shortcut.
