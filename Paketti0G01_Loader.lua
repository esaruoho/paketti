...
preferences = renoise.Document.create("ScriptingToolPreferences") {
  ...
  pakettiXRNIToWAVSourceFolder="",
  pakettiXRNIToWAVOutputFolder="",
  ...
  pakettiRealtimeSliceShowNewestSlice=false,  -- false = Show Original Sample, true = Show Newest Slice
  pakettiRealtimeSliceSnapGrid=1,  -- 1=Off, 2=1/4, 3=1/8, 4=1/16, 5=1/32, 6=1/64
  ...
  PakettiHyperEditSculptRampMs=120,  -- repeating interval (ms) for the SCULPT hold ramp while stopped
  ...
  pakettiGroovebox8120FollowAPC=false,      -- APC Key 25 "follow with controller": page its step view to track the playhead (per-controller, independent)
  pakettiGroovebox8120FollowMidiMix=false,  -- MidiMix "follow with controller": window its 16 LEDs to track the playhead (per-controller, independent)
  pakettiGroovebox8120FollowLPD8=false,     -- LPD8 "follow with controller": page its 8 pads to track the playhead (per-controller, independent)
  ...
  pakettiAmigoRX2Import = false,
  pakettiSliceFadeOutMs = 2,
  pakettiSliceFadeInMs = 0,
  ...
  --  Overdub start turns the Sample Recorder's Pattern Sync on unconditionally.
  --  See recordtocurrenttrack() in PakettiRecorder.lua.)
  -- MPC Cycler Settings
  ...
  pakettiSliceToolsShowLoopMode = true,
  pakettiSliceToolsShowToPattern = true,
  pakettiSliceToolsShowToPhrase = true,
  pakettiSliceToolsShowMarkerMgmt = true,
  pakettiSliceToolsShowDrumChain = true,
 ...
 Index50="",
  ...
  AppSelection = {
    ...
    FilterArgs5="",
    FilterArgs6="",
    FilterUseStdin1=false,
    FilterUseStdin2=false,
    FilterUseStdin3=false,
    FilterUseStdin4=false,
    FilterUseStdin5=false,
    FilterUseStdin6=false,
    FilterUseStdout1=false,
    FilterUseStdout2=false,
    FilterUseStdout3=false,
    FilterUseStdout4=false,
    FilterUseStdout5=false,
    FilterUseStdout6=false,
    FilterOutputMode="New Instrument",
    SmartFoldersApp1="",
    SmartFoldersApp2="",
    SmartFoldersApp3=""
  },
  ...
  PakettiPatternPreset = {
    ...
    Slot01Name="", Slot02Name="", Slot03Name="", Slot04Name="",
    Slot05Name="", Slot06Name="", Slot07Name="", Slot08Name="",
    Slot09Name="", Slot10Name="", Slot11Name="", Slot12Name="",
    Slot13Name="", Slot14Name="", Slot15Name="", Slot16Name="",
    Slot17Name="", Slot18Name="", Slot19Name="", Slot20Name="",
    Slot21Name="", Slot22Name="", Slot23Name="", Slot24Name="",
    Slot25Name="", Slot26Name="", Slot27Name="", Slot28Name="",
    Slot29Name="", Slot30Name="", Slot31Name="", Slot32Name="",
  },
  PakettiClipboard = {
    Slot01="", Slot01Name="",
    Slot02="", Slot02Name="",
...
if not AppSelection then
  ...
  AppSelection = {
    ...
    AppSelection5 = { value = "" },
    AppSelection6 = { value = "" },
    FilterMode1 = { value = false },
    FilterMode2 = { value = false },
    FilterMode3 = { value = false },
    FilterMode4 = { value = false },
    FilterMode5 = { value = false },
    FilterMode6 = { value = false },
    FilterArgs1 = { value = "" },
    FilterArgs2 = { value = "" },
    FilterArgs3 = { value = "" },
    FilterArgs4 = { value = "" },
    FilterArgs5 = { value = "" },
    FilterArgs6 = { value = "" },
    FilterUseStdin1 = { value = false },
    FilterUseStdin2 = { value = false },
    FilterUseStdin3 = { value = false },
    FilterUseStdin4 = { value = false },
    FilterUseStdin5 = { value = false },
    FilterUseStdin6 = { value = false },
    FilterUseStdout1 = { value = false },
    FilterUseStdout2 = { value = false },
    FilterUseStdout3 = { value = false },
    FilterUseStdout4 = { value = false },
    FilterUseStdout5 = { value = false },
    FilterUseStdout6 = { value = false },
    FilterOutputMode = { value = "New Instrument" },
      ...
      notifier=function(value)
        ...
        vb:column{
          ...
          vb:column{
            ...
            vb:text{style="strong",font="bold",text="Real-Time Slice"},
            vb:row{
              ...
              vb:popup{items={"Show Original","Show Newest Slice"},value=preferences.pakettiRealtimeSliceShowNewestSlice.value and 2 or 1,width=100,
...
PakettiMenuConfigCategoryList = {
  ...
  {label = "DSP Device",                          key = "TrackDSPDevice",          apply = "PakettiMenuApplyTrackDSPDeviceMenus"},
  ...
  {label = "Phrase Editor",                       key = "PhraseEditor",            apply = "PakettiMenuApplyPhraseEditorMenus"},
  {label = "Phrase Grid",                         key = "PhraseGrid"},
  {label = "Phrase Mappings",                     key = "PhraseMappings"},
  {label = "Sample Editor",                       key = "SampleEditor",            apply = "PakettiMenuApplySampleEditorMenus"},
  {label = "Sample Editor Ruler",                 key = "SampleEditorRuler"},
  {label = "Sample FX Mixer",                     key = "SampleFXMixer"},
  {label = "Sample Keyzone",                      key = "SampleKeyzone",           apply = "PakettiMenuApplySampleKeyzoneMenus"},
  {label = "Sample Modulation Matrix",            key = "SampleModulationMatrix"},
  {label = "Sample Navigator",                    key = "SampleNavigator",         apply = "PakettiMenuApplySampleNavigatorMenus"},
  {label = "Track Automation List",              key = "TrackAutomationList"},
}
