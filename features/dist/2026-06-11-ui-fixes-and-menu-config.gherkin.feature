# Pure Gherkin test extracted from features/2026-06-11-ui-fixes-and-menu-config.feature
# (report-card banner stripped; inline # cite: traceability kept)
# Regenerate: python3 print-card.py features/2026-06-11-ui-fixes-and-menu-config.feature
...
Feature: Groovebox 8120 Kit loader status column alignment
  ...
  #   2026-08-25  direct-commit  touched: pakettiMenuConfigDialog
