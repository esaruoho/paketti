# Pure Gherkin test extracted from features/parameter-editor-mixer-and-config.feature
# (report-card banner stripped; inline # cite: traceability kept)
# Regenerate: python3 print-card.py features/parameter-editor-mixer-and-config.feature
