# Pure Gherkin test extracted from features/device-hotswap-missing-to-actual.feature
# (report-card banner stripped; inline # cite: traceability kept)
# Regenerate: python3 print-card.py features/device-hotswap-missing-to-actual.feature
