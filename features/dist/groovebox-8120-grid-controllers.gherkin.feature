# Pure Gherkin test extracted from features/groovebox-8120-grid-controllers.feature
# (report-card banner stripped; inline # cite: traceability kept)
# Regenerate: python3 print-card.py features/groovebox-8120-grid-controllers.feature
