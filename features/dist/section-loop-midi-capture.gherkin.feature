# Pure Gherkin test extracted from features/section-loop-midi-capture.feature
# (report-card banner stripped; inline # cite: traceability kept)
# Regenerate: python3 print-card.py features/section-loop-midi-capture.feature
