...
for i = 1, 6 do
  ...
  PakettiAddMenuEntry{name="Main Menu:Tools:Paketti:Instruments:Custom LFO Envelopes:Apply Custom LFO Preset " .. formatDigits(2,i), invoke=function() pakettiApplyCustomLFO(i) end}
  PakettiAddMenuEntry{name="DSP Device:Paketti:Custom LFO Envelopes:Apply Custom LFO Preset " .. formatDigits(2,i), invoke=function() pakettiApplyCustomLFO(i) end}
end

-- Register menu entries for storing
for i = 1, 16 do
  PakettiAddMenuEntry{name="Main Menu:Tools:Paketti:Instruments:Custom LFO Envelopes:Store Current LFO to Slot " .. formatDigits(2,i), invoke=function() pakettiStoreCustomLFO(i) end}
  PakettiAddMenuEntry{name="DSP Device:Paketti:Custom LFO Envelopes:Store Current LFO to Slot " .. formatDigits(2,i), invoke=function() pakettiStoreCustomLFO(i) end}
end

-- Register menu entries for loading
for i = 1, 16 do
  local menu_prefix = (i == 1) and "--" or ""
  PakettiAddMenuEntry{name=menu_prefix .. "Main Menu:Tools:Paketti:Instruments:Custom LFO Envelopes:Load LFO from Slot " .. formatDigits(2,i), invoke=function() pakettiLoadCustomLFO(i) end}
  PakettiAddMenuEntry{name=menu_prefix .. "DSP Device:Paketti:Custom LFO Envelopes:Load LFO from Slot " .. formatDigits(2,i), invoke=function() pakettiLoadCustomLFO(i) end}
end
