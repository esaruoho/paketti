...
-- Add menu entries
PakettiAddMenuEntry{name="Instrument Box:Paketti:Export XI (FastTracker II Extended Instrument)",invoke=function() PakettiXIExport() end}
PakettiAddMenuEntry{name="Main Menu:Tools:Paketti:Export XI (FastTracker II Extended Instrument)", invoke=function() PakettiXIExport() end}
PakettiAddMenuEntry{name="Main Menu:File:Paketti Export:Export XI (FastTracker II Extended Instrument)", invoke=function() PakettiXIExport() end}
