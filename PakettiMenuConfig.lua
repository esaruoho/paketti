...
if preferences.pakettiMenuConfig.MainMenuFile.value then
...
renoise.tool():add_menu_entry{name="Main Menu:Tools:Paketti:Import/Export:Octatrack:Generate Drumkit (Play to End)",invoke=function() PakettiOTDrumkitPlayToEnd() end}
renoise.tool():add_menu_entry{name="Main Menu:Tools:Paketti:Import/Export:.WT:Wavetable Control...", invoke = show_wavetable_dialog}
renoise.tool():add_menu_entry{name="Main Menu:Tools:Paketti:Import/Export:.WT:Import Wavetable...", invoke = paketti_import_wavetable}
renoise.tool():add_menu_entry{name="Main Menu:Tools:Paketti:Import/Export:.WT:Export Wavetable...", invoke = paketti_export_wavetable}
end
...
if preferences.pakettiMenuConfig.Automation.value then
...
if preferences.pakettiMenuConfig.PatternSequencer.value then
...
if preferences.pakettiMenuConfig.TrackDSPDevice.value then
...
if preferences.pakettiMenuConfig.Mixer.value then
...
renoise.tool():add_menu_entry{name = "Main Menu:Tools:Paketti Gadgets:Execute Commands...",invoke = PakettiExecuteShowDialog}
renoise.tool():add_menu_entry{name = "Main Menu:Options:Auto Control Disk Browser on Song Load",invoke = pakettiAutoHideDiskBrowserToggle,selected = pakettiAutoHideDiskBrowserIsEnabled}
end
...
if preferences.pakettiMenuConfig.TrackDSPChain.value then
...
if preferences.pakettiMenuConfig.MainMenuTools.value then
renoise.tool():add_menu_entry{name="--Main Menu:Tools:Paketti:Import/Export:Octatrack Bank (.strd/.work)...",invoke=function() PakettiOTSTRDImporter() end}
...
if preferences.pakettiMenuConfig.SampleNavigator.value then
...
if preferences.pakettiMenuConfig.PatternSequencer.value then
renoise.tool():add_menu_entry{name="Pattern Sequencer:Paketti:Render Pattern Matrix Selection to New Instrument",invoke=function() pakettiRenderMatrixSelection() end}
end
...
renoise.tool():add_menu_entry{name="Main Menu:Tools:Paketti:Import/Export:Batch Pakettify Wave Files in Folder to XRNI (Save Only)...", invoke = PakettiBatchWaveToXRNI}
renoise.tool():add_menu_entry{name="Main Menu:Tools:Paketti:Import/Export:Batch Pakettify Wave Files in Folder to XRNI & Load...", invoke = function() PakettiBatchWaveToXRNI(true) end}
end

if preferences.pakettiMenuConfig.DiskBrowserFiles.value then
renoise.tool():add_menu_entry{name="Disk Browser:Paketti:Import/Export:Batch Pakettify Wave Files in Folder to XRNI (Save Only)...", invoke = PakettiBatchWaveToXRNI}
renoise.tool():add_menu_entry{name="Disk Browser:Paketti:Import/Export:Batch Pakettify Wave Files in Folder to XRNI & Load...", invoke = function() PakettiBatchWaveToXRNI(true) end}
end

if preferences.pakettiMenuConfig.InstrumentBox.value then
renoise.tool():add_menu_entry{name="Instrument Box:Paketti:Import/Export:Batch Pakettify Wave Files in Folder to XRNI (Save Only)...", invoke = PakettiBatchWaveToXRNI}
renoise.tool():add_menu_entry{name="Instrument Box:Paketti:Import/Export:Batch Pakettify Wave Files in Folder to XRNI & Load...", invoke = function() PakettiBatchWaveToXRNI(true) end}
end
...
renoise.tool():add_menu_entry{name = "Main Menu:Tools:Paketti:Samples:Trim Selected Sample to Selection and Normalize",invoke = pakettiTrimSelectedSampleToSelectionAndNormalize}
...
renoise.tool():add_menu_entry{name = "Sample Editor:Paketti:Process:Trim Selected Sample to Selection and Normalize",invoke = pakettiTrimSelectedSampleToSelectionAndNormalize}
...
if preferences.pakettiMenuConfig.MainMenuTools.value then
renoise.tool():add_menu_entry{name="Main Menu:Tools:Paketti:Import/Export:Batch Convert SFZ to XRNI (Save Only)...", invoke = PakettiBatchSFZToXRNI}
renoise.tool():add_menu_entry{name="Main Menu:Tools:Paketti:Import/Export:Batch Convert SFZ to XRNI & Load...", invoke = function() PakettiBatchSFZToXRNI(true) end}
end

if preferences.pakettiMenuConfig.DiskBrowserFiles.value then
renoise.tool():add_menu_entry{name="Disk Browser:Paketti:Import/Export:Batch Convert SFZ to XRNI (Save Only)...", invoke = PakettiBatchSFZToXRNI}
renoise.tool():add_menu_entry{name="Disk Browser:Paketti:Import/Export:Batch Convert SFZ to XRNI & Load...", invoke = function() PakettiBatchSFZToXRNI(true) end}
end

if preferences.pakettiMenuConfig.InstrumentBox.value then
renoise.tool():add_menu_entry{name="Instrument Box:Paketti:Import/Export:Batch Convert SFZ to XRNI (Save Only)...", invoke = PakettiBatchSFZToXRNI}
renoise.tool():add_menu_entry{name="Instrument Box:Paketti:Import/Export:Batch Convert SFZ to XRNI & Load...", invoke = function() PakettiBatchSFZToXRNI(true) end}
end
...
if PAKETTI_API >= 6.2 then
  ...
  if preferences.pakettiMenuConfig.MainMenuTools.value then
    ...
    renoise.tool():add_menu_entry{name="--Main Menu:Tools:Paketti:V3.5:Example Tool...",invoke=function() pakettiGUIDemo() end}
  end
  if preferences.pakettiMenuConfig.DiskBrowserFiles.value then
...
renoise.tool():add_menu_entry{name="--Instrument Box:Paketti:Load:Load XRNI & Wipe Phrases",invoke=function() loadXRNIWipePhrases() end}
renoise.tool():add_menu_entry{name="--Instrument Box:Paketti:Load:Wipe Phrases on Selected Instrument",invoke=function() wipePhrases() end}
renoise.tool():add_menu_entry{name="Instrument Box:Paketti:Load:Load XRNI & Disable Phrases",invoke=function() loadXRNIWipePhrasesTwo() end}
renoise.tool():add_menu_entry{name="Instrument Box:Paketti:Load:Load XRNI & Keep Phrases",invoke=function() loadXRNIKeepPhrases() end}
...
renoise.tool():add_menu_entry{name="Sample Editor:Paketti:Wipe&Slice:Whole Hog (Complete Workflow)",invoke=function() whole_hog_complete_workflow() end}
  ...
  -- REPORT-CARD >> features/sample-slice-menu-grouping.feature
  renoise.tool():add_menu_entry{name="--Sample Editor:Paketti:Beatsync:Double Beatsync Line",invoke=function() doubleBeatsyncLinesSelected() end}
  renoise.tool():add_menu_entry{name="Sample Editor:Paketti:Beatsync:Halve Beatsync Line",invoke=function() halveBeatsyncLinesSelected() end}
  renoise.tool():add_menu_entry{name="Sample Editor:Paketti:Slices:Slice Drumkit (Percussion)", invoke=slicePercussionDrumKit}
  renoise.tool():add_menu_entry{name="Sample Editor:Paketti:Slices:Slice Drumkit (Texture)", invoke=sliceTextureDrumKit}
  renoise.tool():add_menu_entry{name="--Sample Editor:Paketti:Beatsync:Beatsync Lines Halve (All)",invoke=function() halveBeatsyncLinesAll() end}
  renoise.tool():add_menu_entry{name="Sample Editor:Paketti:Beatsync:Beatsync Lines Halve (Selected Sample)",invoke=function() halveBeatsyncLinesSelected() end}
  renoise.tool():add_menu_entry{name="Sample Editor:Paketti:Beatsync:Beatsync Lines Double (All)",invoke=function() doubleBeatsyncLinesAll() end}
  renoise.tool():add_menu_entry{name="Sample Editor:Paketti:Beatsync:Beatsync Lines Double (Selected Sample)",invoke=function() doubleBeatsyncLinesSelected() end}
  renoise.tool():add_menu_entry{name="--Sample Editor:Paketti:Beatsync:Analyze Slice Markers",invoke=function() analyze_slice_markers() end}
...
renoise.tool():add_menu_entry{name="Sample Editor:Paketti:Instruments:Set Selected Instrument Velocity Tracking Off",invoke=function() selectedInstrumentVelocityTracking(0) end}
  renoise.tool():add_menu_entry{name="--Sample Editor:Paketti:Beatsync:Convert Beatsync to Sample Pitch",invoke=convert_beatsync_to_pitch}
...
renoise.tool():add_menu_entry{name="Sample Editor:Paketti:Instruments:Pakettify Current Instrument",invoke=function() PakettiInjectDefaultXRNI() end}
  renoise.tool():add_menu_entry{name="Sample Editor:Paketti:Beatsync:Smart Beatsync from Selection",invoke=function() BeatsyncFromSelection() end}
...
renoise.tool():add_menu_entry{name="Pattern Editor:Paketti:Write Notes:Write Notes Pro Ascending",invoke=function() writeNotesMethodPro("ascending") end}
renoise.tool():add_menu_entry{name="Pattern Editor:Paketti:Write Notes:Write Notes Pro Descending",invoke=function() writeNotesMethodPro("descending") end}
renoise.tool():add_menu_entry{name="Pattern Editor:Paketti:Write Notes:Write Notes Pro Random",invoke=function() writeNotesMethodPro("random") end}
...
renoise.tool():add_menu_entry{name="Main Menu:Tools:Paketti:Import/Export:Convert IFF to WAV...",invoke=convertIFFToWAV}
renoise.tool():add_menu_entry{name="Main Menu:Tools:Paketti:Import/Export:Convert WAV to IFF...",invoke=convertWAVToIFF}
renoise.tool():add_menu_entry{name="Main Menu:Tools:Paketti:Import/Export:Save Current Sample as IFF...",invoke=saveCurrentSampleAsIFF}
renoise.tool():add_menu_entry{name="Main Menu:Tools:Paketti:Import/Export:Import .RX2",invoke=function() 
  local filename = renoise.app():prompt_for_filename_to_read({"*.RX2","*.rx2"}, "ReCycle .RX2 Import tool")
  if filename then rx2_loadsample(filename) end end}
...
renoise.tool():add_menu_entry{name="Main Menu:Tools:Paketti:Import/Export:Import .REX",invoke=function() 
  local filename = renoise.app():prompt_for_filename_to_read({"*.REX"}, "ReCycle .REX Import tool")
  if filename then rex_loadsample(filename) end end}



renoise.tool():add_menu_entry{name="Main Menu:Tools:Paketti:Import/Export:Import .SF2 (Single XRNI per Preset)",
  invoke=function()
    local f = renoise.app():prompt_for_filename_to_read({"*.sf2"}, "Select SF2 to import")
    if f and f ~= "" then import_sf2(f) end
  end
}
renoise.tool():add_menu_entry{name="Main Menu:Tools:Paketti:Import/Export:Extract .SF2 Samples (Chromatic)",
  invoke=function() PakettiSF2ExtractSamplesChromatic() end
}
renoise.tool():add_menu_entry{name="Main Menu:Tools:Paketti:Import/Export:Extract .SF2 Samples (Original Pitch)",
  invoke=function() PakettiSF2ExtractSamplesOriginalPitch() end
}
...
renoise.tool():add_menu_entry{name="--Pattern Sequencer:Paketti:Sequences/Sections:Sequence Selection (Next)",invoke=tknaSequenceSelectionNext}
renoise.tool():add_menu_entry{name="Pattern Sequencer:Paketti:Sequences/Sections:Sequence Selection (Previous)",invoke=tknaSequenceSelectionPrevious}
...
renoise.tool():add_menu_entry{name="Disk Browser Files:Paketti:Load:Load XRNI & Disable Phrases",invoke=function() loadXRNIWipePhrasesTwo() end}
renoise.tool():add_menu_entry{name="Disk Browser Files:Paketti:Load:Load XRNI & Keep Phrases",invoke=function() loadXRNIKeepPhrases() end}
...
-- (skipped: "Paketti:Flood Fill Note and Instrument" already has a MIDI mapping elsewhere)
...
-- DSP / Sidechain triggers (5)
pkmidi("Paketti:Create Kick Trigger Instrument", function() PakettiCreateTriggerInstrument("Kick Trigger") end)
pkmidi("Paketti:Create Snare Trigger Instrument", function() PakettiCreateTriggerInstrument("Snare Trigger") end)
pkmidi("Paketti:Create Hat Trigger Instrument", function() PakettiCreateTriggerInstrument("Hat Trigger") end)
pkmidi("Paketti:Save Sidechain Recipe...", function() PakettiSidechainSaveRecipePrompt() end)
pkmidi("Paketti:Load Sidechain Recipe...", function() PakettiSidechainLoadRecipePrompt() end)

-- Effect Columns (7) — function-based actions (parametric +N tails left to keyboard)
pkmidi("Paketti:Invert Effect Column Subcolumns", function() invert_content("effectcolumns") end)
pkmidi("Paketti:Wipe All Effect Columns on Selected Track on Song", function() wipe_effect_columns(false, true) end)
pkmidi("Paketti:Wipe All Effect Columns on Selected Pattern", function() wipe_effect_columns(true, false) end)
pkmidi("Paketti:Wipe All Effect Columns on Song", function() wipe_effect_columns(true, true) end)
pkmidi("Paketti:(Uxx) Selection Slide Pitch Up +1", function() effectamount(1, "0U") end)
pkmidi("Paketti:(Dxx) Selection Slide Pitch Down +1", function() effectamount(1, "0D") end)
pkmidi("Paketti:(Gxx) Selection Glide +1", function() effectamount(1, "0G") end)

-- Process (sample DSP) — normalize / invert / silence / fades / sign / bit-depth /
-- mono / truncate / trim / misc
pkmidi("Paketti:Normalize Sample", function() normalize_selected_sample_ultra_fast() end)
-- (skipped: "Paketti:Normalize All Samples in Instrument" already mapped elsewhere)
pkmidi("Paketti:Normalize Slices Independently", function() normalize_selected_sample_by_slices() end)
pkmidi("Paketti:Normalize Selected Sample -12dB", function() normalize_and_reduce("current_sample", -12) end)
pkmidi("Paketti:Normalize Selected Instrument -12dB (All Samples & Slices)", function() normalize_and_reduce("all_samples", -12) end)
pkmidi("Paketti:Normalize All Instruments -12dB", function() normalize_and_reduce("all_instruments", -12) end)
pkmidi("Paketti:Invert Left Channel", function() PakettiSampleInvertLeftChannel() end)
pkmidi("Paketti:Invert Right Channel", function() PakettiSampleInvertRightChannel() end)
pkmidi("Paketti:Invert Sample", function() PakettiSampleInvertEntireSample() end)
pkmidi("Paketti:Invert Random Samples in Instrument", function() PakettiInvertRandomSamplesInInstrument() end)
-- (skipped: "Strip Silence" + "Move Beginning Silence to End" already mapped elsewhere)
pkmidi("Paketti:Move Beginning Silence to End for All Samples", function() PakettiMoveSilenceAllSamples() end)
pkmidi("Paketti:15 Frame Fade In & Fade Out", function() apply_fade_in_out() end)
pkmidi("Paketti:Cross-fade Loop Edges (Fixed End)", function() crossfade_loop_edges_fixed_end() end)
pkmidi("Paketti:Toggle Signed/Unsigned", function() paketti_toggle_signed_unsigned() end)
pkmidi("Paketti:Scale Unsigned to Signed", function() paketti_float_sign() end)
pkmidi("Paketti:Convert to 8-bit", function() convert_bit_depth(8) end)
pkmidi("Paketti:Convert to 16-bit", function() convert_bit_depth(16) end)
pkmidi("Paketti:Convert to 24-bit", function() convert_bit_depth(24) end)
pkmidi("Paketti:Convert to 32-bit", function() convert_bit_depth(32) end)
pkmidi("Paketti:Convert All Samples to 8-bit", function() convert_all_samples_to_bit_depth(8) end)
pkmidi("Paketti:Convert All Samples to 16-bit", function() convert_all_samples_to_bit_depth(16) end)
pkmidi("Paketti:Convert All Samples to 24-bit", function() convert_all_samples_to_bit_depth(24) end)
pkmidi("Paketti:Convert All Samples to 32-bit", function() convert_all_samples_to_bit_depth(32) end)
pkmidi("Paketti:Convert Stereo to Mono (Keep Left)", function() stereo_to_mono_optimized(1) end)
pkmidi("Paketti:Convert Stereo to Mono (Keep Right)", function() stereo_to_mono_optimized(2) end)
pkmidi("Paketti:Convert Stereo to Mono (Mix Both)", function() stereo_to_mono_mix_optimized() end)
pkmidi("Paketti:Convert All Samples to Mono (Keep Left)", function() convert_all_samples_to_mono("left") end)
pkmidi("Paketti:Convert All Samples to Mono (Keep Right)", function() convert_all_samples_to_mono("right") end)
pkmidi("Paketti:Convert All Samples to Mono (Mix Both)", function() convert_all_samples_to_mono("mix") end)
pkmidi("Paketti:Mono to Left with Blank Right", function() mono_to_blank_optimized(1, 0) end)
pkmidi("Paketti:Mono to Right with Blank Left", function() mono_to_blank_optimized(0, 1) end)
-- (skipped: Truncate Sample 2x/4x/8x/16x/32x/64x + Trim to Loop Points already have MIDI mappings elsewhere)
pkmidi("Paketti:Trim Selected Sample to Selection", function() pakettiTrimSelectedSampleToSelection() end)
-- (skipped: Trim Selected Sample to Selection and Normalize already mapped elsewhere)
pkmidi("Paketti:Trim All Samples to Loop Points", function() pakettiTrimAllSamplesToLoop() end)
pkmidi("Paketti:FT2 Minimize Selected Sample", function() pakettiMinimizeToLoopEnd() end)
...
-- (skipped: "Paketti:Paketti Function Search..." already has a MIDI mapping elsewhere)
