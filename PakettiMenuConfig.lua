...
pkmidi("Paketti:Normalize All Samples in Instrument", function() normalize_all_samples_in_instrument() end)
...
pkmidi("Paketti:Strip Silence", function() PakettiStripSilence() end)
pkmidi("Paketti:Move Beginning Silence to End", function() PakettiMoveSilence() end)
...
pkmidi("Paketti:Truncate Sample 2x", function() PakettiSampleTruncater(2) end)
pkmidi("Paketti:Truncate Sample 4x", function() PakettiSampleTruncater(4) end)
pkmidi("Paketti:Truncate Sample 8x", function() PakettiSampleTruncater(8) end)
pkmidi("Paketti:Truncate Sample 16x", function() PakettiSampleTruncater(16) end)
pkmidi("Paketti:Truncate Sample 32x", function() PakettiSampleTruncater(32) end)
pkmidi("Paketti:Truncate Sample 64x", function() PakettiSampleTruncater(64) end)
pkmidi("Paketti:Trim Selected Sample to Loop Points", function() pakettiTrimSelectedSampleToLoop() end)
pkmidi("Paketti:Trim Selected Sample to Selection", function() pakettiTrimSelectedSampleToSelection() end)
pkmidi("Paketti:Trim Selected Sample to Selection and Normalize", function() pakettiTrimSelectedSampleToSelectionAndNormalize() end)
