...
function pakettiTimestretchDialog()
    ...
    note_slider = vb:slider{
        ...
        value = 48,
        width=300,
        steps = pakettiSteps(1, 12),  -- Small steps = 1, large steps = 12 (one octave)
        notifier=function(new_value)
    ...
    bpm_slider = vb:slider{
        ...
        width=300,
        steps = pakettiSteps(1, 10),  -- Small steps = 1, large steps = 10
        notifier=function(new_value)
    ...
    lpb_slider = vb:slider{
        ...
        width=300,
        steps = pakettiSteps(1, 16),  -- Small steps = 1, large steps = 16
        notifier=function(new_value)
            new_value = math.floor(new_value)  -- Ensure whole number
...
step_slider = vb:slider{
    ...
    value = 1,
    width=200,
    steps = pakettiSteps(1, -1),  -- Small steps = 1, large steps = 1
    notifier=function(new_value)
