...
if (result ~= 0) then
  ...
  -- Options > "Sliced Imports Also Go Into Amigo": hand the freshly decoded
...
--------------------------------------------------------------------------------
PakettiAddMenuEntry{name="Sample Editor:Paketti:Export:Convert:Octatrack:Batch Convert RX2 to OT (WAV+.ot)...",invoke=PakettiBatchRX2ToOT}
...
--------------------------------------------------------------------------------
PakettiAddMenuEntry{
  name   = "--Sample Editor:Paketti:Export:Convert:Batch Convert RX2 to XRNI...",
