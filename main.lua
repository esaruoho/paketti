...
timed_require("PakettiPluginSlots")
timed_require("PakettiPatternSequencer")
timed_require("PakettiRemoveEmptyColumns")
timed_require("PakettiSplitByInstrument")
timed_require("PakettiFindMultiInstrumentColumns")
timed_require("PakettiRemoveMissingPlugins")
...
timed_require("PakettiNoteReleaseGate")
...
timed_require("PakettiAutomationInterpolate")
timed_require("PakettiRandomizeEffect")
timed_require("PakettiDeviceCopyDialog")
timed_require("PakettiSidechainCurves")
timed_require("PakettiSidechainDoofer")
timed_require("PakettiAutomateLastTouched")
timed_require("PakettiMainMenuEntries")
timed_require("PakettiDialogOfDialogsSmokeTest")
...
timed_require("PakettiBeatsyncSeamless")
timed_require("PakettiGlobalGrooveToDelayValues")
timed_require("PakettiAmigo")
timed_require("PakettiSliceFades")
...
timed_require("PakettiTrackNav")
timed_require("PakettiSampleClipboard")
timed_require("PakettiDuplicateInstrumentFinder")
timed_require("PakettiMarks")
timed_require("PakettiInterpolateBeyond")
timed_require("PakettiMultitimbralMidiInput")
