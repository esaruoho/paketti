...
function EZMaximizeSpectrum()
  ...
  PakettiAddMenuEntry{name="Main Menu:Tools:Paketti:EZ Maximize Spectrum",invoke=function() EZMaximizeSpectrum() end}
  PakettiAddMenuEntry{name="Mixer:EZ Maximize Spectrum",invoke=function() EZMaximizeSpectrum() end}
  PakettiAddMenuEntry{name="Pattern Editor:Paketti:EZ Maximize Spectrum",invoke=function() EZMaximizeSpectrum() end}
end
