...
PakettiAddMenuEntry{name="--Sample Editor:Paketti:Slices:Manual Slicer:Fit Slices to Longest Slice with Power of 2 Padding",invoke = paketti_manual_slicer} 
PakettiAddMenuEntry{name="Sample Editor:Paketti:Slices:Manual Slicer:Fit Slices to Longest Slice + Export OT/WAV with CUE",invoke = paketti_manual_slicer_longest_and_export}

-- Menu entries for Shortest Slice mode
PakettiAddMenuEntry{name="--Sample Editor:Paketti:Slices:Manual Slicer:Fit Slices to Shortest Slice with Power of 2 Padding",invoke = paketti_manual_slicer_shortest}
PakettiAddMenuEntry{name="Sample Editor:Paketti:Slices:Manual Slicer:Fit Slices to Shortest Slice + Export OT/WAV with CUE",invoke = paketti_manual_slicer_shortest_and_export}

-- Menu entry for standalone export
PakettiAddMenuEntry{name="--Sample Editor:Paketti:Slices:Manual Slicer:Export Current Sliced Sample as OT/WAV with CUE",invoke = paketti_export_sliced_ot_wav_cue}
