...
--PakettiAddMenuEntry{name="--Main  Menu:Tools:Paketti:!Preferences:Change Fonts (classic)",invoke=function() ChangeFonts1() end}
--PakettiAddMenuEntry{name="Main  Menu:Tools:Paketti:!Preferences:Change Fonts (default)",invoke=function() ChangeFonts2() end}
--PakettiAddMenuEntry{name="Main  Menu:Tools:Paketti:!Preferences:Change Fonts (Agave)",invoke=function() ChangeFonts3() end}
